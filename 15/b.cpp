...
using List = std::array<size_t, 7>;

size_t find_drop_point(const List &position_counts, List &positions) {
  for (int i = 1; ; ++i) {
    bool found = true;
...
int main() {
  const List position_counts = { 17, 3, 19, 13, 7, 5, 11 };
  List positions = { 15, 2, 4, 2, 2, 0, 0 };
